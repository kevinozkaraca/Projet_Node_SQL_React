...
export const deleteComment = (id) => {
  return () => {
    return DELETE(`${ENDPOINTS.DELETE_COMMENT}${id}`).catch((e) => console.log(e));
  };
};

export const deleteCommentByPostId = (id) => {
  return () => {
    return DELETE(`${ENDPOINTS.DELETE_COMMENT_BYPOSTID}${id}`).catch((e) => console.log(e));
  };
};

export const deleteCommentsByUserId = (id) => {
  return () => {
    return DELETE(`${ENDPOINTS.DELETE_COMMENTS_BYUSERID}${id}`).catch((e) => console.log(e));
  };
};
